      ...
      <Flex flex="1 1 auto" flexDirection="column">
        ...
        <Flex py={5} flexDirection="column" alignItems="center" as="section">
          <Container justifyContent="flex-start" flexDirection="column">
            ...
            <p>
              Telegram Directory ("us", "we",
              "tgdr", or "our") operates the
              https://tgdr.io
              website (the "Service").
            </p>
            ...
            <p>
              ...
              Privacy Policy, terms used in this
              Privacy
            ...
            <ul>
              <li>
                ...
                telegram ID and username, provided
                by Telegram
              </li>
            ...
            <p>
              ...
              anonymous
              unique identifier. Cookies are sent
              to your browser from a website and
              stored
              on your device. Tracking technologies
            ...
            <p>
              ...
              when a
              cookie is being sent. However, if you
              do not accept cookies, you may not be
              able to use some portions of our
              Service.
            </p>
            ...
            <ul>
              ...
              <li>To provide customer care and
                support</li>
              <li>
                To provide analysis or valuable
              ...
              <li>To monitor the usage of the
                Service</li>
              <li>To detect, prevent and address
                technical issues</li>
            </ul>
            ...
            <p>
              ...
              country or
              other governmental jurisdiction where
            ...
            <p>
              Telegram Directory will take all
            ...
            <p>
              Telegram Directory may disclose your
            ...
            <ul>
              ...
              <li>To protect and defend the rights
                or property of Telegram Directory</li>
              <li>
                To prevent or investigate possible
                wrongdoing in connection with the
                Service
              </li>
              <li>To protect the personal safety of
                users of the Service or the public</li>
            ...
            <p>
              ...
              Service-related services or to assist
              us in analyzing how our Service is
              used.
            </p>
            <p>
              ...
              not to disclose or use it for any
              other
              purpose.
            </p>
            ...
            <ul>
              <li>
                ...
                <p>
                  ...
                  This data is shared with other
                  Google
                  services. Google may use the
                  collected data to contextualize
                  and
                ...
                <p>
                  ...
                  available to
                  Google Analytics by installing
                  the Google Analytics opt-out
                  browser
                  add-on. The add-on prevents the
                  Google Analytics JavaScript
                  (ga.js,
                  analytics.js, and dc.js) from
            ...
            <p>
              ...
              other sites that are not operated by
              us. If
              you click on a third party link, you
              will be directed to that third
              party's
              site. We strongly advise you to
              review the Privacy Policy of every
              site you
              visit.
            </p>
            <p>
            ...
            <p>Our Service does not address anyone
              under the age of 18 ("Children").</p>
            <p>
              We do not knowingly collect
              personally identifiable information
              from anyone
              under the age of 18. If you are a
              parent or guardian and you are aware
              that
              your Children has provided us with
            ...
            <p>
              ...
              update the "effective date" at the
              top of
              this Privacy Policy.
            </p>
            <p>
              ...
              effective when they are posted on
              this
              page.
            </p>
            ...
            <p>If you have any questions about this
              Privacy Policy, please contact us:</p>
            <ul>
              <li>By email: support@tgdr.io</li>
            </ul>
          </Container>
        </Flex>
      </Flex>
